	...
	CCreateContext* pContext)
{
	...
	if (!(m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(ControlPanelView), CSize(900, 300), pContext)))
	{
		return FALSE;
	}
	if (!(m_wndSplitter.CreateView(1, 0, RUNTIME_CLASS(ControlPanelView), CSize(900, 50), pContext)))
	{
		return FALSE;
	}
	if (!(m_wndSplitter.CreateView(2, 0, RUNTIME_CLASS(TimelineEditView), CSize(900, 250), pContext)))
	{
		return FALSE;
	}
