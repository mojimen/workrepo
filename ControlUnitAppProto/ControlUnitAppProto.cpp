...
// ControlUnitAppProto.cpp : アプリケーションのクラス動作を定義します。
//
...
// CControlUnitAppProtoApp コンストラクション
...
// 唯一の CControlUnitAppProtoApp オブジェクトです。

CControlUnitAppProtoApp theApp;


// CControlUnitAppProtoApp 初期化
...
// CControlUnitAppProtoApp メッセージ ハンドラー
...
// CControlUnitAppProtoApp のカスタマイズされた読み込みメソッドと保存メソッド
